export default {
  translation: {
    ...
    "Show that you're using Fevela in your notes": 'Mostrar que usas Fevela en tus notas',
    ...
    Protocol: 'Protocolo',
    'Read replies from inboxes only': 'Leer respuestas solo de bandejas de entrada',
    ...
    GroupedNotesHideShortNotes: 'Ocultar notas (demasiado) cortas',
    GroupedNotesSortByRelevance: 'Ordenar notas de usuarios por relevancia',
    ...
    Synching: 'Sincronizando {{current}}/{{total}} perfiles',
