export default {
  translation: {
    ...
    "Show that you're using Fevela in your notes":
      'Montrer que vous utilisez Fevela dans vos notes',
    ...
    Protocol: 'Protocole',
    'Read replies from inboxes only': 'Lire les réponses uniquement depuis les boîtes de réception',
    ...
    Synching: 'Synchronisation {{current}}/{{total}} profils',
