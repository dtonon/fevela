export default {
  translation: {
    ...
    Protocol: 'प्रोटोकॉल',
    'Read replies from inboxes only': 'केवल इनबॉक्स से जवाब पढ़ें',
    ...
    GroupedNotesHideShortNotes: '(बहुत) छोटे नोट्स छुपाएं',
    GroupedNotesSortByRelevance: 'प्रासंगिकता के आधार पर उपयोगकर्ता के नोट्स क्रमबद्ध करें',
