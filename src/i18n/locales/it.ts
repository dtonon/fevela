export default {
  translation: {
    ...
    "Show that you're using Fevela in your notes": 'Mostra che stai usando Fevela nelle tue note',
    ...
    Protocol: 'Protocollo',
    'Read replies from inboxes only': 'Leggi le risposte solo dalle caselle di posta',
    ...
    GroupedNotesHideShortNotes: 'Nascondi note (troppo) brevi',
    GroupedNotesSortByRelevance: 'Ordina le note degli utenti per rilevanza',
