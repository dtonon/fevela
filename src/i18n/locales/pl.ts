export default {
  translation: {
    ...
    "Show that you're using Fevela in your notes": 'Pokaż, że używasz Fevela w swoich notatkach',
    ...
    Protocol: 'Protokół',
    'Read replies from inboxes only': 'Czytaj odpowiedzi tylko ze skrzynek odbiorczych',
