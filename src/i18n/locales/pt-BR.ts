export default {
  translation: {
    ...
    GroupedNotesTimeframe: 'Mostre-me um resumo para usuários individuais do que aconteceu nos últimos',
    GroupedNotesFilterMore:
      'Filtrar usuários que publicaram mais de X notas no período',
