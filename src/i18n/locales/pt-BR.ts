export default {
  translation: {
    ...
    "Show that you're using Fevela in your notes": 'Mostrar que voce usa Fevela nas suas notas',
    ...
    Protocol: 'Protocolo',
    'Read replies from inboxes only': 'Ler respostas apenas das caixas de entrada',
    ...
    GroupedNotesHideShortNotes: 'Ocultar notas (muito) curtas',
    GroupedNotesSortByRelevance: 'Ordenar notas dos usuários por relevância',
    ...
    Synching: 'Sincronizando {{current}}/{{total}} perfis'
  }
}
