export default {
  translation: {
    ...
    "Show that you're using Fevela in your notes": 'Mostrar que está a usar Fevela nas suas notas',
    ...
    GroupedNotesSortByRelevance: 'Ordenar notas dos utilizadores por relevância',
